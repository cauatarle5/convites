/* POST /api/corrigir-resumo — Vercel Serverless Function (correção de resumo, seção 8). */
import { corsHeaders, corrigir, erroHttp } from '../functions/_lib/ia.js';
...
export default async function handler(req, res) {
  ...
  try {
    const r = await corrigir(env, lerBody(req));
